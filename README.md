...
4. Click **Replay training** to watch the model compare the color with each labeled example and keep the closest one.
5. Give the model your own judgment by choosing `delight`, `angry`, `stress`, or `depress`. Your color and label are added as a new training example.
6. Click a training example to test it, or click **Reset my examples** to return to the starter data.
